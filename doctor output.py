...
def get_medicine():
    ...
    if dis in medicine_dict:
        ...
        prescribed = request.form['prescribed']
        ...
        return render_template('index2.html', prescription= final_medi + " dosage: " + "M:" + morning + " AF:" + afternoon + " E:" + evening + " N:" + night)
    else:
        return "Disease not found in the dictionary."
